...
### Security Module
Manages the session variable(s) and manages the photo viewing permissions
...
### Uploading Module
Manages uploading photos, singular and batch
...
### Display Module
Displays photos, allows editing of own photos
...
Used only my the system administrator. Generate OLAP reports for analysis.
